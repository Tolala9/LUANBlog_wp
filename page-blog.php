				...
				<div class="col-sm-12">
					...
					<div class="col-sm-8 col-sm-offset-2">
						<div class="post-inf">
							...
							<div class="post-cat">
								<div class="gray-line"></div>
								<a href="#"><span>wp</span></a>
							</div>

							<div class="post-date">
								<div class="gray-line "></div>
								<span class="date-wrap"><span class="day">12</span><span class="month">
								december 2018</span></span>
							</div>

							<a href="<?php echo get_template_directory_uri(); ?>/post.html"><div class="post-text-wrap">
								<div class="post-text-small">
									<h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sapien ante, volutpat id justo in, efficitur aliquet ligula. Nulla sed lorem et eros interdum sollicitudin. Quisque tristique volutpat mollis. ac ornare turpis vulputatealiquet ligula. Nulla sed lorem et eros interdum in...
									</p>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="col-sm-8 col-sm-offset-2">
						...
						<div class="post-img">
							<a href="<?php echo get_template_directory_uri(); ?>/post.html"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/post_3.jpg" alt=""></a>
						</div>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-8 col-sm-offset-2">
						<div class="post-inf">
							...
							<div class="post-cat">
								<div class="gray-line"></div>
								<a href="#"><span>gulp</span></a>
							</div>

							<div class="post-date">
								<div class="gray-line"></div>
								<span class="date-wrap"><span class="day">4</span><span class="month">
								july 2018</span></span>
							</div>
